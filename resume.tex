...
\begin{itemize}
    % reword
  \item[$\bullet$] Designed a solution for eliminating server downtime during upgrades in a team of four
    \begin{itemize}
  ...
  \item[$\bullet$] Refactored the \textbf{SMB} implementation to increase efficiency SMB 3.1 requests.
    \begin{itemize}
      \item[$\bullet$] Implemented smart pointer-esque objects in C for reduced memory usage and improved safety
    \end{itemize}
